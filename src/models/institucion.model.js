...
const updateInstitucion = async (id_institucion, nombre, telefono, instagram, facebook, direccion, logo, color_principal, color_secundario, fondo, color_pildora1, color_pildora2, color_pildora3) => {
  const query = `
    UPDATE Institucion
    SET nombre = $1, telefono = $2, instagram = $3, facebook = $4, direccion= $5 logo = $6, color_principal = $6, color_secundario = $7, fondo = $8, color_pildora1 = $9, color_pildora2 = $10, color_pildora3 = $11
